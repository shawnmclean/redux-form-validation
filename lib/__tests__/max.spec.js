...
describe('Validator: max', function () {
  it('should be valid when `value` is undefined and `prop` is 3', function () {
    (0, _assert2['default'])((0, _basicValidations.max)({}, undefined, 3) === false);
  });
  it('should be valid when `value` is "99" and `prop` is 100', function () {
    (0, _assert2['default'])((0, _basicValidations.max)({}, '99', 100) === false);
  });
  it('should be valid when `value` is "100" and `prop` is 100', function () {
    (0, _assert2['default'])((0, _basicValidations.max)({}, '100', 100) === false);
  });
  it('should be invalid when `value` is "101" and `prop` is 100', function () {
    (0, _assert2['default'])((0, _basicValidations.max)({}, '101', 100) === true);
  });
  it('should be valid when `value` is 99 and `prop` is 100', function () {
    (0, _assert2['default'])((0, _basicValidations.max)({}, 99, 100) === false);
  });
